...
const producto5 = new Producto("camisaVisitanteDeColombia", "camisadeColombia", 260, 50);
const producto6 = new Producto("camisaRetroDelJunior", "camisaRetroJunior", 180, 50);
